    ...
    <div id="receipt-data">
        <div class="centered">
            <?php if($general_setting->site_logo): ?>
                <img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" height="90" width="90" />
            <?php endif; ?>
            <br>
            <b><?php echo e($lims_biller_data->company_name); ?></b><br>
            <?php echo e(trans('file.Address')); ?>: <?php echo e($lims_warehouse_data->address); ?>

            <br>Hp/Telp: <?php echo e($lims_warehouse_data->phone); ?>
        ...
        <table class="table-data">
            <tbody>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <br><?php echo e($product_sale_data->qty); ?> x <?php echo e(number_format(($product_sale_data->total / $product_sale_data->qty), 0, ',', '.')); ?>
                    ...
                    <td style="text-align:right;vertical-align:bottom"><?php echo e(number_format($product_sale_data->total, 0, ',', '.')); ?></td>
                </tr>
            ...
            <!-- <tfoot> -->
                <tr>
                    ...
                    <th style="text-align:right"><?php echo e(number_format($lims_sale_data->total_price, 0, ',', '.')); ?></th>
                </tr>
                <?php if($general_setting->invoice_format == 'gst' && $general_setting->state == 1): ?>
                <tr>
                    <td colspan="2">IGST</td>
                    <td style="text-align:right"><?php echo e(number_format($total_product_tax, 0, ',', '.')); ?></td>
                </tr>
                <?php elseif($general_setting->invoice_format == 'gst' && $general_setting->state == 2): ?>
                <tr>
                    <td colspan="2">SGST</td>
                    <td style="text-align:right"><?php echo e(number_format(($total_product_tax / 2), 0, ',', '.')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th style="text-align:right"><?php echo e(number_format($lims_sale_data->order_tax, 0, ',', '.')); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->order_discount): ?>
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('file.Order Discount')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format($lims_sale_data->order_discount, 0, ',', '.')); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->coupon_discount): ?>
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('file.Coupon Discount')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format($lims_sale_data->coupon_discount, 0, ',', '.')); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->shipping_cost): ?>
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('file.Shipping Cost')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format($lims_sale_data->shipping_cost, 0, ',', '.')); ?></th>
                </tr>
                <?php endif; ?>
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('file.grand total')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format($lims_sale_data->grand_total, 0, ',', '.')); ?></th>
                </tr>
                <tr>
                    <?php if($general_setting->currency_position == 'prefix'): ?>
                    <th class="centered" colspan="3">Terbilang : <span><?php echo e(str_replace("-"," ",$numberInWords)); ?> Rupiah</span></th>
                    <?php else: ?>
                    <th class="centered" colspan="3">Terbilang : <span><?php echo e(str_replace("-"," ",$numberInWords)); ?></span></th>
                    <?php endif; ?>
                </tr>
            </tbody>
            <!-- </tfoot> -->
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    <td style="padding: 5px;width:30%">Metode Bayar: <?php echo e($payment_data->paying_method); ?></td>
                    <td style="padding: 5px;width:40%"><b><?php echo e(trans('file.Amount')); ?>: <?php echo e(number_format($payment_data->amount, 0, ',', '.')); ?></b></td>
                    <td style="padding: 5px;width:30%"><?php echo e(trans('file.Change')); ?>: <?php echo e(number_format($payment_data->change, 0, ',', '.')); ?></td>
                </tr>                
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr><td class="centered" colspan="3">
                    <?php echo e(trans('file.Thank you for shopping with us. Please come again')); ?><br>
...
<?php /**PATH /home/u1272680/public_html/posnew/resources/views/sale/invoice.blade.php ENDPATH**/ ?>
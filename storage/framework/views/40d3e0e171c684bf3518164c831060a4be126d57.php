                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <td class="col-sm-2 product-title"><strong><?php echo e($product_data->name); ?></strong> [<?php echo e($product_data->code); ?>] <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> </td>
                                                    <?php if($product_batch_data): ?>
                                                    <td class="col-sm-2">
                                                      <input type="text" class="form-control batch-no" value="<?php echo e($product_batch_data->batch_no); ?>" required />
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1272680/public_html/pos/resources/views/sale/create_sale.blade.php ENDPATH**/ ?>
...
<div class="row">
  <div class="container-fluid">
    <div class="col-md-12">
        ...
        <?php if($customer->points): ?>
        <div class="brand-text float-right mt-4">
            <h3><?php echo e(trans('file.Reward Points')); ?>: <span><?php echo e($customer->points); ?></span> </h3>
            <h3><?php echo e(trans('file.One Point is Equivalent to:')); ?>

                <?php if($general_setting->currency_position == 'prefix'): ?>
                    <span><?php echo e($currency->code); ?> <?php echo e($lims_reward_point_setting_data->per_point_amount); ?></span>
                <?php else: ?>
                    <span><?php echo e($lims_reward_point_setting_data->per_point_amount); ?> <?php echo e($currency->code); ?></span>
                <?php endif; ?>
            </h3>
        </div>
        <?php endif; ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1272680/public_html/pos/resources/views/customer_index.blade.php ENDPATH**/ ?>